...
<head>
  ...
  <title>UMKM JIWAN | Dashboard</title>
  ...
  // }
  if (is_array($visitor) && count($visitor) > 0) {
    foreach ($visitor as $result) {
        $bulan[] = $result->tgl; // ambil bulan
        $value[] = (float) $result->jumlah; // ambil nilai
    }
} else {
    // Handle jika $visitor bukan array atau kosong
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2023 <a href="#">Rosyid Muarif</a>.</strong> All rights reserved. </a>
    </footer>
